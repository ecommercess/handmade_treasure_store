<?php
    ...
    require_once '../controllers/SellerEmailVerification.php';
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="basic-login">
                        <h3 class="text-center mb-60">SIGN UP (SELLER)</h3>
                        <form action="signup-seller.php" method="post" enctype="multipart/form-data">
                            ...
                            <div style="text-align: center;">
                                <span>Have an account already? <a href="login-seller.php" style="color: #fe4536;"> LOG IN HERE </a></span>
                            </div>
                        </form>
                    </div>
                </div>
