<?php
    ...
    if (isset($_POST['email']) && isset($_POST['password'])) {
        ...
        if ($output) {            
            ...
            if ($output['role'] == 'customer' && $output['verified'] == 1) {
                header('location: ../home.php');
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="basic-login">
                        <h3 class="text-center mb-60">LOG IN (CUSTOMER)</h3>
                        <form action="login.php" method="post">
                            ...
                            <div style="text-align: center;">
                                <span>Don't have an account? <a href="signup.php" style="color: #fe4536;"> SIGN UP HERE </a></span>
                            </div>
                        </form>
                    </div>
                </div>
