...
// Check if changePassword is submitted
if (isset($_POST['changePassword'])) {
    // Sanitize user inputs
    $user->id = $_GET['id'];
    $user->password = $_POST['password']; // Hash the password
    ...
    if ($user->changePassword()) {
        ...
        // Redirect user to user profile page after saving
                            ...
                            <form method="post" action="changePassword.php?id=<?php echo $_GET['id'] ?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password" id="password" name="password" class="form-control"  required value="<?php if(isset($_POST['password'])) { echo $_POST['password']; } ?>" >
